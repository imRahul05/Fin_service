    ...
    <div className="relative overflow-hidden rounded-3xl border border-border/80 bg-card p-6 sm:p-7 shadow-card transition-colors">
      ...
      {showHealthScore ? (
        <div className="mt-5 grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
          ...
          {/* 3 Bento Highlight Cards + Strategic Callout */}
        ...
        <div className="mt-4 space-y-3.5">
          {/* Strategic Executive Summary Callout Bar */}
          <div className="rounded-2xl border border-border/60 bg-muted/30 p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-3.5 rounded-2xl border border-border/60 bg-muted/20">
              <div className="flex items-center justify-between text-2xs font-semibold text-muted-foreground">
                <span className="uppercase tracking-wider">Monthly Savings</span>
                <span className="h-2 w-2 rounded-full bg-foreground" />
              </div>
              <div className="mt-1.5 font-bold text-foreground text-sm sm:text-base">
                {formatCurrency(numMonthlySavings)}
              </div>
            ...
            <div className="p-3.5 rounded-2xl border border-border/60 bg-muted/20">
              <div className="flex items-center justify-between text-2xs font-semibold text-muted-foreground">
                <span className="uppercase tracking-wider">Debt-to-Income</span>
                <span className="h-2 w-2 rounded-full bg-foreground" />
              </div>
              <div className="mt-1.5 font-bold text-foreground text-sm sm:text-base">
                {numDebtRatio.toFixed(1)}%
            ...
            <div className="p-3.5 rounded-2xl border border-border/60 bg-muted/20">
              <div className="flex items-center justify-between text-2xs font-semibold text-muted-foreground">
                <span className="uppercase tracking-wider">Investments</span>
                <span className="h-2 w-2 rounded-full bg-foreground" />
              </div>
              <div className="mt-1.5 font-bold text-foreground text-sm sm:text-base">
                {formatCurrency(numTotalInvestments)}
