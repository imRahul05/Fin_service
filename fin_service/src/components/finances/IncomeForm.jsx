...
const IncomeForm = ({ income, handleIncomeChange, totalIncome, setActiveTab }) => {
  return (
    <div className="px-4 py-5 sm:p-6">
      <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Monthly Income</h3>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Enter all your sources of monthly income</p>
      ...
      <div className="mt-6 flex justify-between items-center border-t border-gray-200 dark:border-gray-700 pt-4">
        <p className="text-sm font-medium text-gray-900 dark:text-gray-200">
          Total Monthly Income: <span className="font-bold text-blue-600 dark:text-blue-400">{formatCurrency(totalIncome)}</span>
        </p>
        <button
          type="button"
