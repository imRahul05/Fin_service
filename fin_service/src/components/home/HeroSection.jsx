...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-20 sm:pt-20 sm:pb-28 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors">
      {/* Clean soft ambient glow backdrop (no grid) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[420px] bg-plain-hero pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800/80 shadow-xs mb-6 transition-colors">
          ...
          <p className="mt-5 text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
            FinSage AI models your Indian taxes, PPF, NPS, mutual funds, and life scenarios to help you save taxes, eliminate leaks, and build lasting wealth.
          </p>
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            {currentUser ? (
              <Link
                to="/dashboard"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl text-base font-semibold text-white bg-blue-600 hover:bg-blue-500 shadow-md shadow-blue-600/20 transition-all"
              >
                Go to Dashboard
              ...
              <>
                <Link
                  to="/register"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl text-base font-semibold text-white bg-blue-600 hover:bg-blue-500 shadow-md shadow-blue-600/20 transition-all group"
                >
          ...
          <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
            ...
            <div className="p-4 sm:p-5 bg-slate-50/50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2.5">
                Select a financial goal to view AI reasoning:
              </p>
                ...
                {HERO_PREVIEWS.map((preview) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-2.5 sm:p-3 rounded-lg text-xs transition-all cursor-pointer ${
                        isSelected
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded ${isSelected ? "bg-white/20 text-white" : "bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-300 font-medium"}`}>
                          {preview.tag}
                        </span>
                      </div>
            ...
            <div className="p-5 sm:p-6 bg-white dark:bg-slate-900">
              <div className="flex flex-col md:flex-row gap-6 items-start justify-between">
                <div className="flex-1 space-y-3">
                  <div className="flex items-center gap-2">
                    <span className="px-2.5 py-0.5 rounded-md text-xs font-semibold bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-900">
                  ...
                  <div className="pt-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
                    {activePreview.highlights.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800 p-2 rounded-md border border-slate-200 dark:border-slate-700"
                      >
                ...
                {/* Clean Financial Health Score Dial Widget */}
                <div className="w-full md:w-44 shrink-0 bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="my-2 relative flex items-center justify-center">
                    <div className="w-14 h-14 rounded-full border-3 border-emerald-500/20 border-t-emerald-600 dark:border-t-emerald-400 flex items-center justify-center">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3.5 max-w-4xl mx-auto text-center">
          <div className="p-4 rounded-xl bg-slate-50/80 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            <p className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white">₹140Cr+</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">Wealth Simulated</p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50/80 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            <p className="text-2xl sm:text-3xl font-extrabold text-blue-600 dark:text-blue-400">12,500+</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">Scenarios Optimized</p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50/80 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            <p className="text-2xl sm:text-3xl font-extrabold text-emerald-600 dark:text-emerald-400">₹32,000</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">Avg Tax Saved / User</p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50/80 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            <p className="text-2xl sm:text-3xl font-extrabold text-slate-800 dark:text-slate-200">100%</p>
