      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-3 text-base sm:text-lg text-slate-600 dark:text-slate-400">
            From Section 80C to Sovereign Gold Bonds and FIRE planning, FinSage AI combines AI reasoning with deep financial modeling.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-6xl mx-auto">
          ...
          {/* Bento Card 1: AI Advisor */}
          <div className="md:col-span-2 rounded-2xl p-6 sm:p-7 bg-slate-50/70 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 shadow-md transition-all flex flex-col justify-between group">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-xl bg-blue-600 text-white flex items-center justify-center shadow-xs">
                  <Bot className="w-5 h-5" />
                </div>
                <span className="inline-flex items-center gap-1 px-3 py-0.5 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                Ask any complex financial question in plain language. FinSage AI computes tax regimes, debt payoffs, and inflation-adjusted roadmaps with zero bias.
              </p>
          ...
          <div className="rounded-2xl p-6 sm:p-7 bg-slate-50/70 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 shadow-md transition-all flex flex-col justify-between">
            <div>
              <div className="w-10 h-10 rounded-xl bg-slate-800 text-white dark:bg-slate-700 flex items-center justify-center mb-4">
          ...
          <div className="md:col-span-2 rounded-2xl p-6 sm:p-7 bg-slate-50/70 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 shadow-md transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center">
                  <Building2 className="w-5 h-5" />
                </div>
                <span className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950 px-2.5 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800">
                  Tax Law Aware
                </span>
              </div>
              ...
              <div className="mt-5 p-3.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 space-y-2.5">
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1">
                    ...
                    <span className="text-emerald-600 dark:text-emerald-400 font-semibold">38% (Ideal &gt; 25%)</span>
                  </div>
                  <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                    <div className="w-[38%] h-full bg-emerald-600 dark:bg-emerald-500 rounded-full" />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1">
                    ...
                    <span className="text-blue-600 dark:text-blue-400 font-semibold">7.2 Months</span>
                  </div>
                  <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                ...
                <div>
                  ...
                  <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                    <div className="w-[16%] h-full bg-slate-800 dark:bg-slate-300 rounded-full" />
                  </div>
                </div>
              </div>
            </div>
